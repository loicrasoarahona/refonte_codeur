        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-left">
                    <h6 class="text-uppercase text-info mb-0">Sections</h6>
                    <h1 class="text-white mb-3"><span class="font-weight-bold"></span> Politique de confidentialités</h1>
                    <h6 class="text-white-50 mb-5">01/01/2023</h6>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-md-9">
                <div id="intro" class="mb-4">
                    ...
                    <!-- Title -->
                    <div class="mb-3">
                        <h2 class="h5">Welcome to GESTION DES MEMBRES</h2>
                    </div>
                    <!-- End Title -->
                    <p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("GESTION DES MEMBRES"), located at 153 Williamson Plaza, Maggieberg, MT 09514, England, United Kingdom.
                    </p>
                ...
                <div id="services" class="mb-4">
                    ...
                    <ul class="text-secondary">
                        <li class="pb-2">When you register for a GESTION DES MEMBRES account we collect your full name, email address, and account log-in credentials.</li>
                        ...
                        <li class="pb-2">When you use the "Remember Me" feature of GESTION DES MEMBRES Checkout, we collect your email address, payment card number, CVC code and expiration date.</li>
                    </ul>
                    <p>When you respond to GESTION DES MEMBRES emails or surveys we collect your email address, name and any other information you choose to include in the body of your email or responses. If you contact us by phone, we will collect the phone number you use to call GESTION DES MEMBRES. If you contact us by phone as a GESTION DES MEMBRES User, we may collect additional information in order to verify your identity.</p>
                    <!-- Title -->
                ...
                <div id="privacy" class="mb-4">
                    ...
                    <!-- End Title -->
                    <p>GESTION DES MEMBRES's privacy policies explain how we treat your personal data and protect your privacy when you use our Services. By using our Services, you agree that GESTION DES MEMBRES can use such data in accordance with our privacy policies.</p>
                ...
                <div id="yourContent" class="active">
                    ...
                    <p>When you upload, submit, store, send or receive content to or through our Services, you give GESTION DES MEMBRES (and those we work with) a worldwide license to use, host, store, reproduce, modify, create derivative works (such as those resulting from translations, adaptations or other changes we make so that your content works better with our Services), communicate, publish, publicly perform, publicly display and distribute such content. The rights you grant in this license are for the limited purpose of operating, promoting, and improving our Services, and to develop new ones. This license continues even if you stop using our Services (for example, for a business listing you have added to GESTION DES MEMBRES Maps). Some Services may offer you ways to access and remove content that has been provided to that Service. Also, in some of our Services, there are terms or settings that narrow the scope of our use of the content submitted in those Services. Make sure you have the necessary rights to grant us this license for any content that you submit to our Services.</p>
                </div>
            </div>
            <div class="col-md-3">
