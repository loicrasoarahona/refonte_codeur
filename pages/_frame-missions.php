                                        ...
                                        <div class="col-sm-6">
                                            <div class="js-form-message">
                                                <div class="form-group">
                                                    <input type="text" class="has-validation form-control" name="s" value="<?php if(isset($_GET['s'])){ echo $_GET['s']; } ?>" placeholder="Chercher une offre">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="js-form-message">
                                                <div class="form-group">
                                                    <select class="form-control grp-add" name="grp">
                                                        <option value="all" <?php if ($_GET["grp"] == "all"){ echo "selected"; } ?>>Catégorie</option>
                                                        <?php
                                ...
                                foreach ($all_offers as $dones_offers)
                                {
                                    ...
                                    if($quota*1 > count($p) || $quota*1 == 0 )
                                    {
                                        ...
                                        <div class="col-xl-4 col-sm-6 mb-4">
                                            <div class="stor-card custom-card shadow-sm h-100" data-toggle="modal" data-target="#offre_<?php echo $id_line; ?>">
                                                ...
                                                <div class="p-3 pt-4">
                                                    <div class="custom-card-body">
                                                        <p class="text-gray"><?php echo $short_description; ?></p>
                                                    </div>
                                                    <div class="custom-card-footer mb-2">
                                                        <span class="text-primary" style="font-size: 1.25rem;"><i class="icofont-sale-discount"></i><?php echo displayMontant($remuneration, 2, ' €'); ?></span>
                                                    </div>
                                                    <div class="custom-card-footer mb-2">
                                                        <button class="btn btn-orange float-right mb-2" type="button" data-toggle="modal" data-target="#offre_<?php echo $id_line; ?>">Obtenir cette offre</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
