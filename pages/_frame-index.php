	            ...
	            <div class="row">
	                ...
	                <div class="col-lg-6 col-md-6 col-sm-6">
	                    ...
	                    <p class="mb-0" style="font-size: 18px;">
	                        ...
	                        <span class="text-warning font-weight-bold"><?= displayMontant($dones_boutiqueGagnants['montant'], 2, ' €'); ?></span>
	                    </p>
	            ...
	            <div class="row">
	                ...
	                <div class="col-lg-6 col-md-6 col-sm-6">
	                    <p class="mb-0" style="font-size: 18px;">
	                        ...
	                        <span class="text-warning font-weight-bold"><?= displayMontant($euros_stats, 2, ''); ?></span>
	                    </p>
	            ...
	            <div class="row">
	                ...
	                <div class="col-lg-6 col-md-6 col-sm-6">
	                    <p class="mb-0" style="font-size: 18px;">
	                        ...
	                        <span class="text-warning font-weight-bold"><?php echo $j; ?></span>
	                    </p>
