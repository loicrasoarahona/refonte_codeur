<div class="section-padding bg-dark">
    <div class="container">
        <div class="row align-items-center py-4">
            <div class="col-md-6">
                <h1 class="text-primary display-4 font-weight-bold">Pouvez-vous préciser votre <span class="text-warning">besoin</span> ?</h1>
                <h5 class="mb-2 text-white-50 font-weight-light">Nous sommes là pour vous aider<h5>
            </div>
    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-md-12 text-center mb-5">
                Vous n'avez pas trouvé de solution à votre problème ? N'hésitez pas à visiter notre section <a href="aide.html">aide</a>.
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="mb-4">
                    <h4 class="font-weight-light mt-3">Besoin d'<span class="font-weight-bold">aide</span> ?</h4>
