...
?>
            ...
            <div class="transaction-list">
                ...
                <div class="transaction-list-item" style="overflow: hidden;">
                    ...
                    <div class="transaction-list-item-price flexy">
                        <?= $boutonstatus; ?>
                        <a href="coupons.php?action=update&id=<?= $dones_couponss['id']; ?>" class="button secondary-dark">Modifier</a>
                    </div>
                </div>
                <!-- /TRANSACTION LIST ITEM -->
                <?php endforeach; ?>
                </form>
                <?php if ($pageActuelle != 1) { $page_p = ($pageActuelle - 1); ?><a href="<?= url_panel; ?>/coupons.html?page=<?php echo $page_p; ?>"><div class="button secondary cursor-pointer display-inline-block">Page précédente</div></a><?php } else { ?><div class="button secondary-dark cursor-not-allowed display-inline-block">Page précédente</div><?php } ?>
                <?php if (($pageActuelle == 1 AND $nombreDePages > $pageActuelle) OR $nombreDePages > $pageActuelle) { $page_s = ($pageActuelle + 1); ?><a href="<?= url_panel; ?>/coupons.html?page=<?php echo $page_s; ?>"><div class="button secondary cursor-pointer display-inline-block" style="float : right;">Page suivante</div></a><?php } else { ?><div class="button secondary-dark cursor-not-allowed display-inline-block" style="float : right;">Page suivante</div><?php } ?><div class="clear"></div>
            </div>
            <!-- /TRANSACTION LIST -->
        </div>
        <!-- DASHBOARD CONTENT -->
    <?php elseif ($_GET['action'] == 'add'):?>
        ...
        <div class="dashboard-content">
            ...
            <div class="headline buttons primary">
                ...
                <a href="<?= url_panel; ?>/coupons.html" class="button mid-short primary">Retour</a>
            </div>
            <!-- /HEADLINE -->
                ...
                <div class="form-box-item" style="width: 100%;">
                    ...
                    <form id="profile-info-form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" id="nom" name="nom" value="<?= $post_nom; ?>" placeholder="Entrez le nom du coupon..." required>
                        </div>
                        <!-- /INPUT CONTAINER -->
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" id="url" name="url" value="<?= $post_url; ?>" placeholder="Entrez l'url du coupon..." required>
                        </div>
                        <!-- /INPUT CONTAINER -->
                        ...
                        <div class="input-container half">
                            ...
                            <input type="text" id="code" name="code" placeholder="Le code du coupon" value="<?= $post_code; ?>" required>
                        </div>
                        <!-- /INPUT CONTAINER -->
                        ...
                        <div class="input-container half">
                            ...
                            <input type="text" id="dateDebut" name="dateDebut" value="<?= $post_dateDebutCoupon ?>" required>
                        </div>
                        <!-- /INPUT CONTAINER -->
    ...
    <?php elseif ($_GET['action'] == 'update'):?>
        ...
        $sqlMissions = $pdo->query("SELECT * FROM coupons WHERE id = '".intval($_GET['id'])."'");
                ...
                <div class="form-box-item" style="width:100%;">
                    ...
                    <form id="profile-info-form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-container">
                            <label for="typecoupon" class="rl-label required">Type de coupon</label>
							<select name="typecoupon" id="typecoupon" placeholder="Entrez le type du coupon..." required>
								<option value="coupon" <?= ($typecoupon=='coupon'?'selected="selected"':'') ?>>Coupon Code</option>
								<option value="printable" <?= ($typecoupon=='printable'?'selected="selected"':'') ?>>Printable Coupon</option>
								<option value="discount" <?= ($typecoupon=='discount'?'selected="selected"':'') ?>>Online Discount/Sale</option>
							</select>                           
                        </div>
                        <!-- /INPUT CONTAINER -->
                        ...
                        <div class="input-container">
                            <label for="nom" class="rl-label required">Nom du coupon</label>
                            <input type="text" id="nom" name="nom" value="<?= $nomOffre; ?>" placeholder="Entrez le nom du coupon..." required>
                        </div>
                        <!-- /INPUT CONTAINER -->
                        ...
                        <div class="input-container">
                            <label for="code" class="rl-label required">Code du coupon</label>
                            <input type="text" id="code" name="code" value="<?= $codecoupon; ?>" placeholder="Entrez le code du coupon..." required>
                        </div>
                        <!-- /INPUT CONTAINER -->
                        ...
                        <div class="input-container">
                            <label for="url" class="rl-label required">Url du coupon</label>
                            <input type="text" id="url" name="url" value="<?= $urlOffre; ?>" placeholder="Entrez l'url du coupon..." required>
                        </div>
                        <!-- /INPUT CONTAINER -->
