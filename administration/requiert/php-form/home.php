<?php	
if (!class_exists('PHPMailer-m\PHPMailer\Exception'))
           {
                   require 'PHPMailer-m/src/Exception.php';
               require 'PHPMailer-m/src/PHPMailer.php';
             require 'PHPMailer-m/src/SMTP.php';
              }
	...
	if (!empty($_POST['send'])) {
		...
		$headers .= "From: comfirmation du compte sur my-qassa.com <webmaster@my-qassa.com>\n";
		$headers .= "Reply-To: No Reply <webmaster@my-qassa.com>\n";
...
';
 ...
 $mail = new PHPMailer\PHPMailer\PHPMailer();
                ...
                $mail->SMTPAuth   = true;                                   
                $mail->Username   = 'webmaster@maxiconcour.com';                     
                $mail->Password   = 'Cameron12300@';                                
                $mail->SMTPSecure = 'tls';         
                $mail->Port       = 587;      
              

                //Recipients
                $mail->setFrom('webmaster@maxiconcour.com', 'My Qassa');

                //loop each to email
                $mail->addAddress($post_reg_email);  
                $mail->addReplyTo('webmaster@maxiconcour.com');
