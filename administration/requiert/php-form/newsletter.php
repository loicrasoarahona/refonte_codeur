<?php
	if (!empty($_POST['submit_newsletter'])) {
		if (isset($_POST['message'])) {
			...
			$headers .= "From: Newsletter Maxiconcour.com <webmaster@Maxiconcour.com>\n";
			$headers .= "Reply-To: No Reply <noreply@Maxiconcour.com>\n";
...
';
                ...
                $mail->Password   = 'Timo12300@';                              
                $mail->SMTPSecure = 'tls';         
                $mail->Port       = 587;    
                

                //Recipients
                $mail->setFrom('webmaster@maxiconcour', 'My Qassa');
