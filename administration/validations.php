            ...
            <section class="bg-light-grey absolute-section-1 margin-base">
                ...
                <div class="pack-boxes">
                    ...
                    <div class="pack-box">
                        ...
                        <center>
                            <a href="<?= url_panel; ?>/validations.php?action=prevalidation" class="button btn-primary btn-icon-split ">Voir</a>
                        </center>
                    ...
                    <div class="pack-box">
                        ...
                        <p class="credit">Cliquez pour voir les pré-validations</p>
                        <center>
                            <a href="<?= url_panel; ?>/validations.php?action=prevalidationCashback" class="button btn-primary btn-icon-split">Voir</a>
                        </center>
                    ...
                    <div class="pack-box">
                        ...
                        <center>
                            <a href="<?= url_panel; ?>/validations.php?action=validation" class="button btn-primary btn-icon-split">Voir</a>
                        </center>
                        ...
                        if ($_GET['action'] == 'validation') {
                            ...
                            <script>
                              function loadPage(param) {
                                self.location.href="<?= url_site ?>/administration/validations.php?action=validation"+param;
                              }
                            </script>
                            <?php
                        }
